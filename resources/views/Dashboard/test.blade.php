            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="{{asset('dist/img/user3-128x128')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="#" class="dropdown-item">
                        <span class="float-right text-muted text-sm">
                           ...
                           <div class="text-info">   {{ Auth::user()->email }} </div>
                        </span>
                    </a>
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="{{route('profile')}}" class="dropdown-item dropdown-footer">المزيد من الاعدادات </a>
                </div>
            </li>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @foreach(\App\Menu::where('active',1)->orderBy('list','ASC')->get() as $meun )
                                <?php $m_role = json_decode($meun->user_role);  ?>
                               @if(in_array(Auth::User()->role,$m_role))

                            <li class="nav-item">
                                <a href="{{route($meun->route_name)}}" class="nav-link">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('show_register')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon text-red"></i>
                                    <p>طلبات التسجيل في دورة</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('show_courses')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon text-warning "></i>
                                    <p>جدول الدوارات</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-header">خصائص النظام </li>
                    ...
                    <li class="nav-header">خصائص</li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="nav-icon far fa-circle text-danger"></i>
                            <p class="text">اضافة</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">
